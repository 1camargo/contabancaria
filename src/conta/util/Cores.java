...
public class Cores {
				...
				// Reset Color - Resetar cores
				public static final String TEXT_RESET = "\u001B[0m";
			
				// Text Color - Cores básicas
				...
				// Text Color Bold - Cores básicas em negrito
				...
				// Reset Text Underline - Cores básicas em sublinhado
				...
				// Text Color High Intensity - Cores básicas em cores mais brilhosas
				...
				// Text Color Bold High Intensity - Cores básicas em cores mais brilhosas (negrito)
				...
				// Background Color - Cores básicas (fundo da tela)
				...
				// Background Color High Intensity - Cores básicas em cores mais brilhosas (fundo da tela)
